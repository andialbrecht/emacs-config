...
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit outline-1 :foreground "#4788cc" :slant normal :weight bold))))
 '(org-level-2 ((t (:inherit outline-2 :foreground "tan3" :weight semi-bold))))
...
(custom-set-variables
 ...
 '(safe-local-variable-values (quote ((epylint . "~/.virtualenvs/dlgi/bin/epylint") (python-pylint-options "-f parseable" "-d I" "-d W0511" "--rcfile=~/devel/dlgi/tools/pylint.rc") (python-pylint-options "-f parseable" "-d I" "-d W0511" "--rcfile=~/devel/dlgi/pylint.rc") (python-pylint-options "-rn" "-f parseable" "-d I" "-d W0511" "--rcfile=~/devel/dlgi/pylint.rc") (python-pylint-command . "PYTHONPATH=~/devel/dlgi/ ~/.virtualenvs/dlgi/bin/python ~/.virtualenvs/dlgi/bin/pylint") (virtualenv-default-directory . "/home/andi/devel/avsam/applikation") (virtualenv-workon . "avsweb") (virtualenv-default-directory . "/home/andi/devel/proto_puforms/src") (virtualenv-workon . "protopuf") (show-trailing-whitespace . t) (org-export-latex-image-default-option . "width=30em"))))
