...
(defun color-theme-tango-3 ()
  ...
  (color-theme-install
   '(color-theme-tango
     ...
     (flymake-warnline ((t (:foreground "#edd400" :underline t))))
     (diff-added ((t (:inherit diff-changed :foreground "olivedrab"))))
     (diff-file-header ((((class color) (min-colors 88) (background dark)) (:background "grey10" :weight bold))))
     (diff-function ((t (:inherit diff-header :background "black" :foreground "yellow"))))
     (diff-header ((((class color) (min-colors 88) (background dark)) (:background "grey10" :foreground "white" :weight bold))))
     (diff-hunk-header ((t (:inherit diff-header :background "black"))))
     (diff-removed ((t (:inherit diff-changed :foreground "sienna"))))
     (font-latex-sectioning-5-face ((((type tty pc) (class color) (background light)) (:foreground "yellow" :weight bold))))
     )))
