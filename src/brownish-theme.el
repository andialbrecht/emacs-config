;;; brownish-theme.el --- A brownish theme

;; Copyright (C) 2011  Andi Albrecht

;; Author: Andi Albrecht <andi@karidol>
...
(let ((light-blue "#C5F8FF")
  ...
  (custom-theme-set-faces
   'brownish
   `(default ((((min-colors 4096)) (:background ,background :foreground "#d8d8d8"))))
   ...
   `(font-lock-string-face ((t (:foreground ,light-yellow))))
   ...
   `(info-xref-visited ((t (:foreground ,light-yellow))))
   ...
   '(org-level-1 ((t (:bold t :foreground "#4788cc"))))
   '(org-level-2 ((t (:bold t :foreground "#6ac214"))))
   '(org-level-3 ((t (:bold t :foreground "#edd400"))))
   '(org-level-4 ((t (:bold t :foreground "tomato"))))
   ...
   '(org-agenda-date ((t (:underline nil :foreground "SkyBlue2"))))
...
(provide-theme 'brownish)
;;; brownish.el ends here
