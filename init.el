...
(custom-set-faces
 ...
 '(gnus-cite-1 ((((class color) (background light)) (:foreground "slategray"))) t)
 ...
 '(gnus-header-name ((((class color) (background dark)) (:foreground "olivedrab"))) t)
 '(gnus-header-subject ((t (:foreground "#edd400" :weight bold))) t)
 ...
 '(hl-line ((t (:inherit highlight :background "grey20"))) t)
 ...
 '(mm-uu-extract ((((type tty) (class color) (background dark)) (:background "grey20"))) t)
