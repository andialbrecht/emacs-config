...
#+end_src
** LaTeX
The LaTeX class and xetex setup is copied from [[http://emacs-fu.blogspot.com/2011/04/nice-looking-pdfs-with-org-mode-and.html][this blog post]]. Without
xetex you'll need to change the fonts in the LaTeX class too.

*** TODO: Refactor those snippets, there's no need for a snippet for each lang
#+begin_src emacs-lisp
